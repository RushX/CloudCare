...
function Navbar() {
  ...
  //  const ind=data.indexOf('shivering')
  // //  console.log(nums)
  //  nums[ind]=1 
  //  console.log(nums)
    return (
  <>
    <div className="w-full flex px-9 py-3 text-black justify-between">
      <div className="brandName text-2xl cursor-pointer">D-Chain</div>
      <div className="navigator flex gap-3 text-[#05445E] items-center">
        ...
        <div className="status flex items-center">
          <button className={`button w-2 h-2 ${accounts ? 'bg-[#16FF00]' : 'bg-red'} rounded-full`}></button>
        </div>
      </div>
    </div>
  </>
